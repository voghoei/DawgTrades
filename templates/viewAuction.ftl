		...
		<div class="panel panel-default">
			...
			<ul class="list-group">
				<li class="list-group-item">
					...
					<p class="list-group-item-text">${auction.getExpiration()?datetime("MM/dd/yyyy hh:mm a")}</p>
				</li>
				<li class="list-group-item">
		  	...
		  	<#if bids?size gt 0>
		  		<ul class="list-group">
		  			<#list bids?chunk(5)?first as bid>
		  				<li class="list-group-item">$${bid.getAmount()} on ${bid.getDate()?datetime("MM/dd/yyyy hh:mm a")}</li>
		  			</#list>
		  		</ul>
	  		<#else>
				<ul class="list-group">
